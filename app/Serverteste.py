...
class eventHandler(Resource):
    def eventhandler(self):
        parser_upload = parser.copy()
        parser_upload.add_argument('eventType', help='type can not be null', required=True)
        parser_upload.add_argument('package', help='type can not be null', required=True)
        data = parser_upload.parse_args()
...
class test (Resource):
    def post(self):
        parser_upload = parser.copy()
        parser_upload.add_argument('eventType', help='type can not be null', required=True)
        parser_upload.add_argument('nItems', help='type can not be null', required=True)
        data = parser_upload.parse_args()
        print(data)
        # eventType = data['eventType']
        # nItems = data['nItems']
        # for i in range(nItems):
        #     parser_upload.add_argument('package' + str(i), help='type can not be null', required=True)
        # data = parser_upload.parse_args()
        # print(data)
        # for i in range(nItems):
        #     package[i] = data['package' + str(i)]
        #     print(package[i])


api.add_resource(eventHandler, '/eventHandler', endpoint="eventHandler")
